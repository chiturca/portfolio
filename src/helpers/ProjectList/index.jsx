...
export const ProjectList = [
  {
    ...
    summary:
      'A platform where every refugee can interact with and create content, created with team',
  ...
  },
  {
    ...
    summary: 'A single page web game platform based on filling the blanks, created with team',
