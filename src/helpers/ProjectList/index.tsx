...
export const TestList = [
  {
    ...
    website: "",
    report:
      "https://drive.google.com/file/d/1FOIWl7_iOqzGxp5pg1Rh62YymXcLsSoc/view?usp=drive_link",
...
export const FrontList = [
  {
    id: 9,
    name: "Avare Ink",
    image: `https://i.ibb.co/tmK0pbp/Ekran-g-r-nt-s-2024-02-03-005912.png`,
    skills: "Next.js, Firebase, TailwindCSS",
    summary: `AvareInk is a Next.js and Firebase-based web application tailored for a local tattoo studio.`,
    github: "https://github.com/chiturca/Avare_Ink",
    website: "https://avare-ink.vercel.app/en/book",
    report: "",
    boxShadow: "",
  },
  {
  ...
  },
  {
    ...
    summary:
      "A single page platform demonstrates famous hangman game (created with a team)",
  ...
  },
  {
    ...
    skills: "JavaScript, CSS, HTML",
    summary:
      "A single page web game platform based on filling the blanks (created with a team)",
    github:
      "https://github.com/Recoded-Spark-Turkey-2022/mad-libs-runtime-terror",
...
export const UnityList = [
  {
    ...
    skills: "Unity, C#",
    summary:
      "Nostalgic 2D game where player kills aliens and get points with thier spaceship",
