...
export const ExperienceList = [
  ...
  },
  {
    ...
    color: "#fff",
    icon: <WorkIcon />,
    h3: "In Silico Commerce & Software Development",
    h4: "Frontend Developer - Full Time",
    p: "Creating frontend applications with Angular & TS. Creating UX-UI design with Figma.",
    logo: I,
    img: "",
  },
  {
    ...
    h3: "Panteon Academy",
    h4: "Game Development",
    p: "Creating 2D & 3D games with Unity, C#",
    logo: P,
    img: panteon,
  },
  {
    ...
    h3: "Royal Apps",
    h4: "Frontend Developer - Full Time",
    p: "Creating embedded apps for B2B Shopify systems with React.js & Polaris.",
    logo: RA,
    img: "",
  },
  {
    ...
    h4: "Web Development",
    p: "Frontend Web Developer specialized on HTML, CSS, JS, React.js",
    logo: RC,
    img: recoded,
  },
  {
  ...
  },
  {
    ...
    icon: <WorkIcon />,
    h3: "RS Plan-Project",
    h4: "Project Writer - Seasonal",
    p: "Erasmus+ Project Writer",
    logo: RS,
    img: "",
  },
  {
